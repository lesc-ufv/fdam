...
DataFlow *Sgfilter::createDataFlow(int id) {
    ...
    auto mult1 = new Multi(idx++, -984);
    auto mult2 = new Multi(idx++, 92);
    ...
    df->connect(reg2, mult5, mult5->getPortA());
    ...
    df->connect(mult6, add3, add3->getPortA());
    ...
    df->connect(mult8, add5, add5->getPortB());
