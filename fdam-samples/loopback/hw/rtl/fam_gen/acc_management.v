...
(
  ...
  (
    ...
    .request_data(req_rd_data_in[1*(ADDR_WIDTH+TAG_WIDTH)-1:0*(ADDR_WIDTH+TAG_WIDTH)]),
    ...
    .write_data(req_wr_data_in[2*(DATA_WIDTH+ADDR_WIDTH+TAG_WIDTH)-1:0*(DATA_WIDTH+ADDR_WIDTH+TAG_WIDTH)]),
