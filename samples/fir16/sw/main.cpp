...
int main(int argc, char *argv[]){
    ...
    short num_dados_in = 512;
    short num_data_out = num_dados_in/16;
    short data_in[num_dados_in];
    short data_out[num_data_out];
    bool flag_error = false;
    
    int fir_const[16] = { 0x1010, 0xf0f, 0xe0e, 0xd0d, 0xc0c, 0xb0b, 0xa0a, 0x909, 0x808, 0x707, 0x606, 0x505, 0x404, 0x303, 0x202, 0x101};
    ...
    dataflow_exec(fir_const,16,data_in,num_dados_in,data_out,num_data_out,true);
