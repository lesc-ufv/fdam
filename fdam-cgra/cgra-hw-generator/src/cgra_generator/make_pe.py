...
from cgra_generator.make_conf_reader_pe import make_conf_reader_pe
...
def make_pe(is_io, pc, memory, data_width,conf_depth):
    ...
    con = [('clk', clk), ('rst', rst), ('conf_bus_in', conf_bus_in), ('conf_wr_en', conf_wr_en),
           ...
           ('init_const_waddr', init_conf_const_waddr), ('init_const',init_conf_const), ('pc_max', pc_max),
           ('pc_loop', pc_loop), ('ignore_until', ignore_until)
           ]

    m.Instance(conf_reader_pe, conf_reader_pe.name, param, con)
