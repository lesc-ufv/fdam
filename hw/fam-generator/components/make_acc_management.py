...
from components.make_acc import make_acc
from components.make_arbiter_controller_rd_req_tree import make_arbiter_controller_rd_req_tree
from components.make_arbiter_controller_wr_req_tree import make_arbiter_controller_wr_req_tree
from components.make_conf_receiver import make_conf_receiver
from components.make_dsm_controller import make_dsm_controller
from components.make_input_queue_controller import make_input_queue_controller
from components.make_output_queue_controller import make_output_queue_controller
