...
print("#############################################################################")
print("#                                                                           #")
print("#                      FAM Sources Files QuickAssist                        #")
print("#                                                                           #")
print("#############################################################################")
end_green_fontcolor()
...
header = "$FAM_BASEDIR/hw/static/afu.json\n\n# For now we force MPF to a particular platform.  This will be fixed later.\n+define+MPF_PLATFORM_BDX\n\nSI:$FAM_BASEDIR/hw/static/base_addenda.txt\nQI:$FAM_BASEDIR/hw/static/static_base_PAR_files.qsf\n\n+incdir+../rtl\n"
fd_sim.write(header)
