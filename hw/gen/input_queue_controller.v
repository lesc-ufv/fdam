...
(
  ...
  output reg [DATA_WIDTH-1:0] afu_user_read_data,
  output reg afu_user_read_data_valid,
  output reg done
);
  ...
  wire rst_internal;
  wire [DATA_WIDTH-1:0] afu_user_read_data_out;
  wire afu_user_read_data_valid_out;
  ...
  (
    ...
    .valid(afu_user_read_data_valid_out),
    .dout(afu_user_read_data_out),
    .count(fifo_count),
    .empty(fifo_empty),
    .full(fifo_full),
